...
2. !!! Внимание, для плагинов работающих через Chrome (на текущий момент это mts2 ростелеком и a1by) на компе должен быть установлен Chrome.
...
## Инструкцию по настройке для автономной работы без MobileBalance смотрите в папке standalone
