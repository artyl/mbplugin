...
Видеоинструкция немного устарела, так что возможны небольшие несостыковки  
...
- __show_captcha__ - При определении что в браузере сработала капча скрытое окно хрома будет показано (не сраотает в режиме headless)
