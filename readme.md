...
2. Распаковать свежую версию сборки в папку где установлен MobileBalance.  
...
Что можно включить:  
* __logginglevel__ - журнал работы mbplugin, по умолчанию включен режим INFO, журнал ведется в папке mbplugin\log, dllplugin пишет в mbplugin.log, jsmbLh плагин пишет в http.log
