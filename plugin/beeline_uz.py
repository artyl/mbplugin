...
user_selectors = {
    'chk_lk_page_js': "document.querySelector('.content-wrapper .auth-content form input[type=password]') == null",
    'chk_login_page_js': "document.querySelector('.content-wrapper .auth-content form input[type=password]') !== null",
    'before_login_js': 'document.querySelectorAll("a").forEach(el=>el.innerText=="ВХОД ПО ПАРОЛЮ"?el.click():0)',
    'login_clear_js': "document.querySelector('.content-wrapper .auth-content form input[type=tel]').value=''",
    'login_selector': '.content-wrapper .auth-content form input[type=tel]',
