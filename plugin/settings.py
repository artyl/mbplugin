...
# Раздел mbplugin.ini [Options] TODO !!! Пока оставил для совместимости, все перенес в переменную ini
# logging
...
ini = {
    'Options': {  # Раздел mbplugin.ini [Options]
        ...
        'mbplugin_ini': 'mbplugin.ini',  # имя ini файла
        ...
        # путь к html файлу, который создается после получения баланса
        'balance_html': '..\\DB\\balance.html',
        'average_days': 30,  # Количество дней для расчета среднего по истории
