...
login_url = 'https://lk.yota.ru/devices'
user_selectors = {
                # 'chk_lk_page_js': "document.querySelector('form input[type=password]') == null",
                'chk_lk_page_js': "window.location.href=='https://lk.yota.ru/devices'",
                'chk_login_page_js': "document.querySelector('form input[type=password]') !== null",
                'login_clear_js': "document.querySelector('form input[id=username]').value=''",
