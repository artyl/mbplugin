...
3. Распаковываем в эту папку содержимое архива (папка mbplugin) либо установить через git (см Установка и обновление через git из github)
4. Для Windows при распаковке из архива у нас уже полный набор, для Linux и Mac смотри ниже в разделе установка окружения на Linux и Mac.
5. Для установки:
...
7. Для получения балансов ```mbp get-balance```, на linux ```./mbp get-balance```
