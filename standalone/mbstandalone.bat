...
if "%1"=="check" mbplugin\python\python mbplugin\plugin\util.py check-ini

if "%1"=="getbalance" mbplugin\python\python mbplugin\plugin\util.py get-balance --only_failed

if "%1"=="getbalancefailed" mbplugin\python\python mbplugin\plugin\util.py get-balance --only_failed
