...
## mbplugin 1.00.01b (??.08.21) Playwright + linux
...
ADD: Для плагинов работающих через браузер можно в виде скриншотов посмотреть как выхлядело получение баланса (View screenshot log)  
