...
Добавлена команда начать новый лог (Flush log) - старый лог переименовывается в файл с текущей датой и его можно удалить  
...
Добавлена комманда restart в httpserver_mobile  
...
BUG: В хроме 90 перестал воспринимать относительный путь к папке профилей, исправлено  
