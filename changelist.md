...
## mbplugin v1.00.10 (23.01.22) Telegram bot command alias and bot menu 
ADD: Алиасы для tg bot (см cmd_alias в секции Telegram)  
ADD: Команды для tg bot меню ```[/]```, т.к. если писать их все то получается большой список, который приходится  (см command_menu_list в секции Telegram)  
