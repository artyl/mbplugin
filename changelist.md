...
## mbplugin v1.00.30 (??.07.22) Button cancel
ADD: Кнопка Cancel для прерывания очереди запросов в тенлеграме и веб интерфейсе (не остановливает текущий запрос, остановит после того как отработает тот что выполняется сейчас).  
