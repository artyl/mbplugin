...
## mbplugin v1.00.03 (??.09.21) Bugfix
...
ADD: Новый функционад, теперь можно в одном плагине размещать несколько различных движков, например WEB и API (beeline) для получения баланса и нужный выбирать указывая plugin_mode в phones.ini  
