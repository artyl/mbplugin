...
## mbplugin 1.00.00b (??.08.21) Playwright + linux
...
CHANGE: исправлена опечатка в названии ключа subscription (было subscription) (нужно исправить в mbplugin.ini, если написано по старому)  
По внутренностям:
