...
FIX: Pasha прислал способ как починить API. API снова работает и включен по умолчанию  

## mbplugin v1.00.20 (12.02.22) Fix plugin работы tele2 (from pasha)
...
FIX: Востановлена работоспособность тестов py.test. Тесты включены как часть деплоя в build build 
