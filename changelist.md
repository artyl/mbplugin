...
## mbplugin v1.00.75 (11.09.24) --ele-- t2, upgrade playwright to 1.46.0
...
BREAKING_CHANGE: сделал разделение, для win7 версия playwright остается 1.14.1, а для win 10 и старше используется последний, сейчас это 1.46.0, для манипуляция с файлом зависимостей сделан параметр requirements через который можно управлять каким файлом зависимостей пользоваться  
