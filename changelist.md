...
ADD: Сделал группы для просмотра, это не совсем то что было описано в (https://github.com/artyl/mbplugin/issues/33) но зато не потребовало больших усилий и минимальные изменения кода  
