...
## mbplugin 0.99.33b (??.08.21) Playwright + linux
Данный релиз очень сильно отличается от предыдущего, так что при переходе возможны проблемы, если вы новичек, то возможно вам стоит пропустить этот релиз если нет поводов срочно переходить, или по крайней мере подождать пока будут отловлены основные проблемы.  
...
Движок работы через браузер изменен с [pyppeteer](https://github.com/pyppeteer/pyppeteer) на [playwright](https://github.com/microsoft/playwright-python) (причины перехода, низкая активность автора pyppeteer, более стабильная работа playwright, активность команды, наличие отладчика, возможность использования в качестве движка firefox и др, асинхронный режим работы и много чего еще хорошего)  
