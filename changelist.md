...
## mbplugin v1.00.75 (05.09.24) --ele-- t2
FIX: tele2 переименовался в t2, поменялся url и разметка на сайте, и самое неприятное ни не хотят больше логиниться по логину и паролю, поэтому приходится включать показ  
...
BREAKING_CHANGE: сделал разделение, для win7 версия playwright остается 1.14.1, а для win 10 и старше используется последний, сейчас это 1.46.0  
