...
ADD: Команды для tg bot меню ```[/]```, т.к. если писать их все то получается большой список, который приходится сколировать (см command_menu_list в секции Telegram)  
...
## mbplugin v1.00.12 (27.01.22) Mts block status
ADD: mts плагин. Добавил отображения статуса блокировки по полю accountBlockStatus  
