...
## mbplugin v1.00.23 (??.04.22) MGTS, smile-net small fixes
...
ADD: параметр jitter - можно задавать задержку перед началом проверки от n до m секунд в формате n,m по умолчанию 1,1 задержку межно задать как общим параметром в mbplugin.ini так и индивидуально для конкретного номера  
