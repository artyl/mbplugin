...
## mbplugin v1.00.21 (20.03.22) Fix beget
FIX: Добавлена задержка в 1 секунду в работу плагина beget т.к. логика работы mbplugin строится из расчета что в одну секунду может быть получено не более одного баланса и всремя уникально, а beget успевает быстрее чем за секунду и в отчете начинают появляться фантомы  
