...
## mbplugin v1.00.02b (??.09.21) Playwright + linux
...
FIX: Изза нестабильности работы с системным прокси добавлена настройка прокси для requests в mbplugin.ini - requests_proxy  
...
ADD: в встроенном планировщике можно не только запрашивать балансы, но и 
