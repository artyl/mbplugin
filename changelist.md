...
ADD: Новая опция login_pause если мы не оказались при заходе сразу в ЛК то начинает авторизацию только спустя указанное количество секунд. Удобно в случае если автоматический логон не срабатывает, а браузет продолжительное время удерживает сессию. Например как у теле2  
