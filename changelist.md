...
## mbplugin 0.99.22 (28.09.20) Small fix
...
Автономная версия. Фильтр получаемых номеров в запросе в автономной версии добавлен Alias.  
Автономная версия. В случае ошибки останавливалось получение балансов. Исправлено.  
Автономная версия. Смотрите исходники. Даже если не умеете програмировать, там есть коментарии, которые в ряде случаев ответят на ваши вопросы.  
Например в settings описаны все параметры ini файла.  
