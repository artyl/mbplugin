...
**Для тех у кого папка mbplugin находится не непосредственно в папке с MobileBalance** При использовании MobileBalance есть тонкий момент, т.к. необходимо сначала распаковать папку mbplugin в папку с MobileBalance.exe, потом перенастроить плагины в MobileBalance по новом пути, а потом уже удалять старую папку mbplugin  
