...
## mbplugin v1.00.72 (29.03.24) mts balance and amount round2
FIX: MTS вернул схему получения баланса - amount берем только при получения баланса через ЛК другого телефона  
