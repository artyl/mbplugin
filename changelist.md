...
REFACTORING: Переработанно большое количество кода, с целью большей управляемости, но без изменения функционала  
ADD: Диагностические сообщения для консольной команды mbp get-balance  