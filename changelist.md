...
## mbplugin v1.00.18 (10.02.22) Исправление работа smsru
...
FIX: Tele2 сломал API через который можно было получать баланс, пришлось переделать на получение через браузер  
