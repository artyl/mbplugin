...
## mbplugin v1.00.83 (30.08.25) 
ADD: добавлен нараметр slowdown, коэфициент замедления работы браузера, по сути множитель для времени ожидания, т.е. дефолтное значение 1, 2 - замедляем в 2 раза, если 0.5 - ускоряем 2 раза  
