...
Значение по умолчанию:   
## __slowdown__
Описание: Коэфициент замедления  
Значение по умолчанию: 1  
## __show_captcha__
...
## __captcha_api_token__
Описание: Токен для анализа капчи через сервис распознавания капчи https://rucaptcha.com, если пусто - не использовать  
Значение по умолчанию:   
## __captcha_token_limit__
Описание: Максимальное количество капч в сутки для распознавания через сервис, 0 - неограничено  
Значение по умолчанию: 100  
## __captcha_logging__
Описание: Логировать капчу  
Значение по умолчанию: 0  
Варианты значения captcha_logging: 0 - выключено или 1 - включено  
## __show_chrome__
Описание: Показывать окно chrome  
Значение по умолчанию: 0  
Варианты значения show_chrome: 0 - выключено или 1 - включено  
## __playwright_stealth__
...
Значение по умолчанию:   
## __tg_api_urls__
Описание: Адреса для API телеграма через запятую, подробности см telebot.apihelper.API_URL, по умолчанию - не менять  
Значение по умолчанию:   
## __api_token__
Описание: Токен для бота  
Значение по умолчанию:   
## __loud_api_token__
Описание: Токен для громких уведомлений бота  
Значение по умолчанию:   
## __auth_id__
Описание: Список id пользователей, которые взаимодействовать с ТГ ботом  
Значение по умолчанию:   
## __tg_enable_notification__
Описание: Включить звук при получении сообщений в телеграм, по умолчанию звук выключен (0)  
Значение по умолчанию: 0  
Варианты значения tg_enable_notification: 0 - выключено или 1 - включено  
