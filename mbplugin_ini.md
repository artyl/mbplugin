...
## __browserengine__
Описание: Движок для работы с браузером  
Значение по умолчанию: PLAYWRIGHT  
Варианты значения browserengine: PYPPETEER PLAYWRIGHT  
...
Значение по умолчанию: C:\Program Files (x86)\Google\Chrome\Application\chrome.exe  
## __log_responses__
...
## __mts_usedbyme__
Описание: По МТС возвращать использованный трафик вместо оставшегося  
Значение по умолчанию: 0  
Варианты значения mts_usedbyme: 0 - выключено или 1 - включено  
...
Описание: Красить номера, баланс по меньше чем  
Значение по умолчанию: 0  
## __realaveragedays__
